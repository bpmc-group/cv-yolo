...
#cv2.setMouseCallback(frame_title, RGB)
...
while True:
    ...
    ''' Reducing count to 2 makes movements slower but smoother 
        ...
        about once per second. At 60, very jerky and things pop in and
        then just disappear). Make this a runtime param for production
    '''
